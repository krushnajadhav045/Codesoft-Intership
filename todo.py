...
class TaskManager:
    def __init__(self, root):
        ...
        root.resizable(0, 0)
        root.configure(bg="#DAE5B5")

        # Frame
        self.functions_frame = Frame(root, bg="#E8EE8E")
    ...
    def create_widgets(self):
        ...
        Button(
            ...
            bg="#D40D0D", font=("arial", "14", "bold"),
            command=self.add_task
        ).place(x=18, y=80)

        Button(
            self.functions_frame, text="Remove", width=15,
            bg="#D40D10", font=("arial", "14", "bold"),
        ...
        self.task_listbox = Listbox(
            ...
            bg="RED", fg="BLACK",
            selectbackground="#FF0000", selectforeground="BLACK"
        )
